...
```
code/
├── image_fact_checker.py      # Core image processing logic
├── app.py                     # Updated Gradio UI
├── test_image_verification.py # Test suite
├── install_dependencies.sh    # Installation script
├── uploaded_images/           # Storage for uploaded images
├── image_metadata/            # JSON metadata files
...
#### `verify_image_news(image_input) -> Tuple[str, str, str, str]`
